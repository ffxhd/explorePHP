...
class PHPMailer
{
    ...
    {
        $addresses = array();
        $functionName = "imap_rfc822_parse_adrlist";
        if( false === function_exists($functionName))
        {
            say("{$functionName} 函数不存在");
        }
    ...
    {
        $functionName = "idn_to_ascii";
        if( false === function_exists($functionName))
        {
            say("{$functionName} 函数不存在");
        }
        $functionName = "mb_convert_encoding";
        if( false === function_exists($functionName))
        {
            say("{$functionName} 函数不存在");
        }
    ...
    protected function generateId()
    {
        ...
        $functionName = "openssl_random_pseudo_bytes";
        if( false === function_exists($functionName))
        {
            say("{$functionName} 函数不存在");
        }
