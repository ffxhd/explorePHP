...
class errorCode
{
    public static $errorCode_mean_array = array(
        '-1'=>'系统繁忙，此时请开发者稍候再试',
        '0'=>'请求成功',
    ...
    public static function getMean($errorCode)
    {
        if (isset(self::$errorCode_mean_array[$errorCode]))
        {
            return self::$errorCode_mean_array[$errorCode];
        }
        else
        {
            return '不在微信接口全局返回码说明内';
        }
    }
